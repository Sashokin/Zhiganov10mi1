...
btn_person_data = types.KeyboardButton('👤Пользовательские настройки')
...
btn_garantee = types.KeyboardButton('🥇Качество продукции')
...
btn_name = types.KeyboardButton('📱Номер телефона')
btn_news = types.KeyboardButton('🛎Уведомления')
btn_show_product = types.KeyboardButton('⚙️Настройка фильтра')
btn_orders = types.KeyboardButton('📦Заказы')
personal_page.row(btn_name, btn_news, btn_show_product)
personal_page.add(btn_orders)
...
btn_input_phone = types.KeyboardButton('🔏Ввести номер телефона')
start_page.add(btn_input_phone, btn_main_menu)
